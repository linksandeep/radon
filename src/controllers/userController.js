...
/*
   const mid2=function(req,res,next){
    ...
    if(data==true){console.log(amount=0)}
    else if(data==false){ let valueD=(data.isfreeappuser.amount)
     let userval=req.body.Newuser.balance
     console.log(valueD-userval)
      next()
   }}
